...
lazy_static! {
    ...
    pub(crate) static ref LUMINO_DICT: HashMap<String, [usize; 12]> = HashMap::from([
        ...
        ("文昌".to_owned(), [6, 7, 1, 3, 6, 7, 1, 3, 6, 7, 7, 6]),
        ("文曲".to_owned(), [7, 7, 3, 6, 7, 7, 1, 6, 3, 7, 1, 6]),
        ("擎羊".to_owned(), [1, 7, 0, 1, 7, 0, 3, 7, 0, 1, 7, 0]),
        ("陀羅".to_owned(), [0, 7, 1, 0, 7, 1, 0, 7, 1, 0, 7, 1]),
        ("火星".to_owned(), [3, 6, 7, 3, 2, 6, 7, 2, 1, 1, 7, 3]),
        ("鈴星".to_owned(), [3, 6, 7, 3, 2, 6, 7, 2, 1, 1, 7, 3]), // 存疑
        ("祿存".to_owned(), [6, 0, 7, 6, 0, 7, 6, 0, 7, 6, 0, 7]),
    ]);
}
